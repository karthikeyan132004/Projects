                    ...
                    element = {
                        ...
                        element = {
                            ...
                            element = {
                                ...
                                Route path = "/leave"
                                element = {
                                    user ? < LeaveManagement user = { user }
                                    onLogout = { handleLogout }
                                    /> : <Navigate to="/login
                                    " />} /> <
                                    Route path = "/content"
                                    element = {
                                        user ? < ContentStudio user = { user }
                                        onLogout = { handleLogout }
                                        /> : <Navigate to="/login
                                        " />} /> <
                                        Route path = "/ai-lab"
                                        element = {
                                            user ? < AILab user = { user }
                                            onLogout = { handleLogout }
                                            /> : <Navigate to="/login
                                            " />} /> <
                                            Route path = "/cloud"
                                            element = {
                                                user ? < CloudPanel user = { user }
                                                onLogout = { handleLogout }
                                                /> : <Navigate to="/login
                                                " />} /> <
                                                Route path = "/research"
                                                element = {
                                                    user ? < ResearchHub user = { user }
                                                    onLogout = { handleLogout }
                                                    /> : <Navigate to="/login
                                                    " />} /> <
                                                    Route path = "/academy"
                                                    element = {
                                                        user ? < AcademyZone user = { user }
                                                        onLogout = { handleLogout }
                                                        /> : <Navigate to="/login
                                                        " />} /> <
                                                        Route path = "/planner"
                                                        element = {
                                                            user ? < PersonalPlanner user = { user }
                                                            onLogout = { handleLogout }
                                                            /> : <Navigate to="/login
                                                            " />} /> <
                                                            Route path = "/finance"
                                                            element = {
                                                                user ? < Finance user = { user }
                                                                onLogout = { handleLogout }
                                                                /> : <Navigate to="/login
                                                                " />} /> <
                                                                Route path = "/attendance"
                                                                element = {
                                                                    user ? < Attendance user = { user }
                                                                    onLogout = { handleLogout }
                                                                    /> : <Navigate to="/login
                                                                    " />} /> <
                                                                    Route path = "/training"
